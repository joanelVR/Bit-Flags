...
BIT_FLAGS bit_flags_init_default(void); /****FIRST BOOK END (DEFAULT)****/
...
BIT_FLAGS bit_flags_init_number_of_bits(int number_of_bits); /*****FIRST BOOK END*****/
...
void bit_flags_destroy(BIT_FLAGS* phBit_flags); /**********SECOND BOOK END***********/
